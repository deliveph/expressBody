...
const TELEPHONE_INPUT = 'TELEPHONE_INPUT',
  ...
  CHOOSECHARUSER = 'CHOOSECHARUSER',
  CHOOSESHIPORDERCURRENTSHIPERADDRESS = 'CHOOSESHIPORDERCURRENTSHIPERADDRESS',
  CHOOSESHIPORDERCURRENTCONSIGNEEADDRESS = 'CHOOSESHIPORDERCURRENTCONSIGNEEADDRESS',
  ISVERIFYSERVICESTATUS = 'ISVERIFYSERVICESTATUS'

export default {
  [ISVERIFYSERVICESTATUS] (state, verifyServiceStatus) {
    state.isVerifyServiceStatus = verifyServiceStatus
  },
  [CHOOSESHIPORDERCURRENTCONSIGNEEADDRESS] (state, consigneeAddress) {
    state.shipOrderCurrentConsignessAddress = consigneeAddress
  },
  [CHOOSESHIPORDERCURRENTSHIPERADDRESS] (state, shiperAddress) {
    state.shipOrderCurrentShiperAddress = shiperAddress
  },
  // ###############################################
  [CHOOSECHARUSER] (state, chatUser) {
    state.chooseChatUser = chatUser
  },
