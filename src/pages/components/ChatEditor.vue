  ...
  <div class="m-chat-editor" @click="hideRobotList">
    ...
    <div class="m-chat-editor-main" :class="{robot:isRobot}">
      <span class="m-chat-change" :class="classObject" @click="changeChat(classObject)">
          <img src="http://yx-web.nos.netease.com/webdoc/h5/im/chat-editor-1.png" v-if="classObject.txt"/>
          <img src="http://yx-web.nos.netease.com/webdoc/h5/im/chat-editor-2.png" v-else />
      </span>
      
      <span class="u-editor-input" v-if="classObject.txt">
        <textarea v-model="msgToSent" ></textarea>
      </span>
      <span class="u-editor-video" v-else>
         按住&nbsp;&nbsp;说话
      </span>
...
export default {
  ...
  methods: {
    changeChat(obj){
      console.log(obj)
      if(!obj.video){
        this.classObject.video = true
        this.classObject.txt = false
      }else{
        this.classObject.video = false
        this.classObject.txt = true
      }
    },
    sendTextMsg () {
